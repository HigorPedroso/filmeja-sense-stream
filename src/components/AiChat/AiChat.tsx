...
export function AiChat({ onShowContent }: AiChatProps) {
  ...
  return (
    <div className="flex flex-col h-[600px] bg-filmeja-dark/50 backdrop-blur-sm rounded-xl border border-white/10">
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex gap-2">
          <input
            ...
            placeholder="Descreva o tipo de filme ou série que você quer assistir..."
            className="flex-1 bg-white/5 text-white rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-filmeja-purple"
          />
          <Button
            onClick={handleSend}
