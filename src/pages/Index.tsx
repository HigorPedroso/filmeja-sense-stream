  ...
  return (
    <div className="min-h-screen bg-filmeja-dark">
      ...
      <section className="py-16 px-4">
        ...
        <DialogContent className="sm:max-w-5xl h-[85vh] sm:h-auto sm:min-h-[600px] overflow-y-auto flex flex-col items-center justify-center [&>button]:hidden p-6 sm:p-8">
        <HomeChat />
        </DialogContent>
      </Dialog>
            </div>
